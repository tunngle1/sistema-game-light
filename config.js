...
window.SITE_CONFIG = {
  ...
  event: {
    ...
    city: 'Москва',
    format: 'Офлайн',
    address: 'Метро Павелецкая/Новокузнецкая, ул. Садовническая 78, стр 5. Ориентир — арка с табличкой «Берегись автомобиля», вход в синюю дверь с табличкой CitrusHall.'
  },
